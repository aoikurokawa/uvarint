...
///
/// // Simple case: 5 fits in 1 byte
/// // 5 = 0b0000_0101
/// // Only need lower 7 bits, MSB=0 (last byte)
/// assert_eq!(encode_u64(5), vec![0x05]);
///
/// // Two bytes: 128
/// // 128 = 0b1000_0000 (bit 7 is set)
/// // Byte 1: bits 0-6 = 0, MSB=1 (more coming) → 0b1000_0000
/// // Byte 2: bit 7 = 1, MSB=0 (done) → 0b0000_0001
